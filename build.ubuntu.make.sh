...
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-thread.static.compile.info
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-thread.dynamic.compile.info
