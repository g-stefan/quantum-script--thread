...
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-thread.static.compile
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-thread.dynamic.compile
