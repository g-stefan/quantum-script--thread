...
echo -^> local-release quantum-script-extension-thread
...
call :cmdX xyo-cc quantum-script-extension-thread --archive-release-sha512 --version-file=source/quantum-script-extension-thread.version.ini
